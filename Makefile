#############################################################################
# Makefile for building: proj3
# Generated by qmake (2.01a) (Qt 4.6.2) on: Sun Dec 13 15:10:51 2015
# Project:  proj3.pro
# Template: app
# Command: /usr/lib64/qt4/bin/qmake -unix -o Makefile proj3.pro
#############################################################################
...
Makefile: proj3.pro  /usr/lib64/qt4/mkspecs/linux-g++-64/qmake.conf /usr/lib64/qt4/mkspecs/common/g++-multilib.conf \
		/usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/qconfig.pri \
		/usr/lib64/qt4/mkspecs/features/qt_functions.prf \
		...
		/usr/lib64/qt4/mkspecs/features/lex.prf \
		/usr/lib64/qt4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -unix -o Makefile proj3.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/proj31.0.0 || $(MKDIR) .tmp/proj31.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/proj31.0.0/ && $(COPY_FILE) --parents DTW.h mainwindow.h Signal.h .tmp/proj31.0.0/ && $(COPY_FILE) --parents DTW.cpp main.cpp mainwindow.cpp Signal.cpp .tmp/proj31.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/proj31.0.0/ && (cd `dirname .tmp/proj31.0.0` && $(TAR) proj31.0.0.tar proj31.0.0 && $(COMPRESS) proj31.0.0.tar) && $(MOVE) `dirname .tmp/proj31.0.0`/proj31.0.0.tar.gz . && $(DEL_FILE) -r .tmp/proj31.0.0
...
DTW.o: DTW.cpp DTW.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o DTW.o DTW.cpp
